...
namespace EcommApp.Migrations
{
    ...
    [Migration("20231009134916_OrdersCard")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommApp.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommApp.Models.MenuItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommApp.Models.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("EcommApp.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommApp.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcommApp.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("EcommApp.Models.CartItem", b =>
                {
                    b.HasOne("EcommApp.Models.MenuItem", "MenuItem")
                        .WithMany()
                        .HasForeignKey("MenuItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EcommApp.Models.ShoppingCart", null)
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("EcommApp.Models.OrderDetails", b =>
                {
                    ...
                    b.HasOne("EcommApp.Models.OrderHeader", null)
            ...
            modelBuilder.Entity("EcommApp.Models.OrderHeader", b =>
                {
                    b.HasOne("EcommApp.Models.ApplicationUser", "User")
                        .WithMany()
